...
<head>
    ...
    <title>Sistema de Gestión de Clínica García - Menú Princiapl - Recepcionista</title>
...
<body>
    ...
    <div class="container text-center mt-5">
        ...
        <a href="logoutRecepcionista.php" class="logout-btn" title="Cerrar sesión">
        ...
        <div class="d-grid gap-3" style="max-width: 400px; margin: auto;">
            ...
            <div class="mb-3">
                <a href="" class="btn btn-primary btn-lg w-100">Registrar pacientes</a>
            </div>

            <div class="mb-3">
                <a href="" class="btn btn-secondary btn-lg w-100">Asignar citas a los pacientes</a>
            </div>

...
<head>
    ...
    <title>Sistema de Gestión de Clínica García - Menú Principal - Administrador</title>
    ...
    <div class="container flex-grow-1 mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="col">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Accede para registrar nuevos empleados en el sistema.</p>
                        <a href="registrarPersonalAdmin.php" class="btn btn-secundario w-100">Registrar personal</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Registrar información personal</h5>
                        <p class="card-text">Añade o actualiza la información del personal existente.</p>
                        <a href="registrarInfoPersonalAdmin.php" class="btn btn-secundario w-100">Registrar información personal</a>
                    </div>
                </div>
            </div>
